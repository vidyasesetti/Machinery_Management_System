...
<div class="container mt-5">
    <a href="viewStatus.jsp?machineId=<%= complaint.getMachineId()%>" class="btn btn-outline-primary">Back</a>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="feedback" rows="3" readonly><%= complaint.getFeedback() %></textarea>
            </div>
            <div class="form-group">
                <label for="datePosted">Date Posted</label>
                <input type="text" class="form-control" id="datePosted" value="<%= complaint.getDatePosted() %>" readonly>
